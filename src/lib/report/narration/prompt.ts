...
- key_findings.growth_areas — 2-3 items, one per "area to confirm". Build each from the AREAS TO CONFIRM — SUPPORTING DETAIL block (and MISCONCEPTIONS). Draw the 2-3 areas from the sub-strands with the lowest correct ratios and/or a surfaced misconception. Each item MUST:
