...
// sushi stimulus (migration 20260618130000) to the private
...
//
// TWO sections: (1) MANIFEST — 42 images (the 19 PR-#78-activated rows + the 5 l1-art-curation rows + the 4 SAM-L0C-Q13 day tiles + the SAM-L0B-Q14 sushi stimulus); and
...
// 42 images: 32 for the 19 PR-#78 activation rows (overlay/l*-activation.json) + 5 for the
// L1 art-curation rows activated by migration 20260614120001 + 4 day-word tiles for
// SAM-L0C-Q13 (Item 3, migration 20260618130200; generated by gen_l0c_q13_tiles.py)
// + 1 sushi stimulus for SAM-L0B-Q14 (Item 1, migration 20260618130000).
...
// from the 42 activation images above — these belong to rows that are already
...
async function main(): Promise<void> {
  ...
  printSection("ACTIVATION IMAGES (42 — 19 PR-#78 rows + 5 l1-art-curation + 4 L0C-Q13 day tiles + 1 L0B-Q14 sushi)", activation);
